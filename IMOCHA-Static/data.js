// ─── MOCK USER ───────────────────────────────────────────────────────────────
const MOCK_USER = {
  id: 'user-001', name: 'Alex Morgan', email: 'admin@skillmatrix.pro',
  avatar: null, role: 'admin', organization: 'SkillMatrix Pro',
  department: 'Engineering', joinedAt: '2023-06-01',
};
const MOCK_CREDENTIALS = { email: 'admin@skillmatrix.pro', password: 'Admin123!' };
...
const mockDashboardData = {
  kpis: [
    ...
    { label:'Monthly Revenue', value:'$48,290', change:15.7, changeType:'increase', description:'Current billing period' },
  ],
  assessmentTrend: [
    { month:'Aug', value:312, secondary:245 }, { month:'Sep', value:389, secondary:298 },
    { month:'Oct', value:445, secondary:367 }, { month:'Nov', value:521, secondary:412 },
    { month:'Dec', value:498, secondary:445 }, { month:'Jan', value:634, secondary:521 },
  ],
  completionTrend: [
    { month:'Aug', value:71.2 }, { month:'Sep', value:73.8 }, { month:'Oct', value:75.1 },
    { month:'Nov', value:76.9 }, { month:'Dec', value:74.3 }, { month:'Jan', value:78.4 },
  ],
  recentActivity: [
...
const mockAnalyticsData = {
  scoreDistribution: [
    { range:'0–20', count:89, percentage:2.3 }, { range:'21–40', count:213, percentage:5.5 },
    { range:'41–60', count:612, percentage:15.9 }, { range:'61–70', count:934, percentage:24.2 },
    { range:'71–80', count:1087, percentage:28.2 }, { range:'81–90', count:723, percentage:18.7 },
  ...
  topSkills: [
    { skill:'SQL', count:756, avgScore:79 }, { skill:'Soft Skills', count:534, avgScore:81 },
    { skill:'React', count:834, avgScore:76 }, { skill:'JavaScript', count:1243, avgScore:74 },
    { skill:'Node.js', count:423, avgScore:73 }, { skill:'TypeScript', count:589, avgScore:72 },
    { skill:'Mobile Dev', count:289, avgScore:72 }, { skill:'Python', count:987, avgScore:71 },
  ],
  passRateTrend: [
    { month:'Aug', value:68.4 }, { month:'Sep', value:70.2 }, { month:'Oct', value:71.8 },
    { month:'Nov', value:73.5 }, { month:'Dec', value:72.1 }, { month:'Jan', value:75.3 },
  ],
  candidateGrowth: [
    { month:'Aug', value:2841, secondary:2234 }, { month:'Sep', value:3012, secondary:2456 },
    { month:'Oct', value:3245, secondary:2678 }, { month:'Nov', value:3567, secondary:2901 },
    { month:'Dec', value:3412, secondary:2789 }, { month:'Jan', value:3847, secondary:3102 },
  ],
...
const mockNotifications = [
  ...
  { id:'notif-004', type:'success', title:'Monthly Report Ready', message:'Your January 2024 analytics report has been generated and is ready for download.', timestamp:'2024-01-21T09:00:00Z', read:true, actionLabel:'Download Report' },
  { id:'notif-005', type:'info', title:'Subscription Renewal', message:'Your Enterprise Plan renews in 14 days. Ensure your billing info is up to date.', timestamp:'2024-01-20T08:00:00Z', read:true, actionLabel:'Manage Billing' },
  { id:'notif-006', type:'error', title:'Failed Email Delivery', message:'3 candidate invitation emails failed to deliver. Please verify email addresses.', timestamp:'2024-01-19T16:45:00Z', read:true, actionLabel:'View Details' },
...
const mockRoles = [
  { id:'role-001', name:'Admin',     description:'Full access to all features',          users:2,  color:'role-admin' },
  { id:'role-002', name:'Manager',   description:'Manage assessments and candidates',    users:8,  color:'role-manager' },
  { id:'role-003', name:'Viewer',    description:'Read-only access to reports',          users:15, color:'role-viewer' },
  { id:'role-004', name:'Recruiter', description:'Invite and manage candidates',         users:12, color:'role-recruiter' },
];
